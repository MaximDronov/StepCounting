...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private int count = 0;
    private TextView text; //Ссылка на ТextView
    ...
    protected void onResume(){ // продолжить
        ...
        sensorManager.registerListener((SensorEventListener) this,
                sensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER), SensorManager.SENSOR_DELAY_NORMAL); // запускаем датчик
    }
    @Override
    protected void onPause(){ // nayзa
